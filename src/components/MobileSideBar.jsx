...
const MobileSideBar = () => {
  ...
  return (
    ...
    <ul className='sidebar_ul'>
        ...
        <img className='mx-3 my-2 ul-after-icon' src={ActivitiesIcon} alt="icon" />
        <li><a href="#">Profile</a></li>
        </div>

        <div className='flex items-center'>  
        <img className='mx-3 my-2 ul-after-icon' src={UsersIcon} alt="icon" />
        <li><a href="#">Log out</a></li>
        </div>
        </ul>
      
        <div className='add_new_project flex px-5 py-2 rounded-lg'>
